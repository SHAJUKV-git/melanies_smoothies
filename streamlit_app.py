...
# st.dataframe(data=my_dataframe, use_container_width=True)   # to print table of all columns

ingredients_list = st.multiselect('Choose upto 5 ingredientss:', my_dataframe, max_selections=5)
